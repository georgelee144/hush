from PyQt5.QtWidgets import QApplication,QWidget,QLabel,QLineEdit,QTextEdit,QHBoxLayout,QPushButton,QVBoxLayout,QFileDialog,QMessageBox
import sys
import hushhush
...
class MainWindow(QWidget):
        ...
        def read_button_Clicked(self):
            ...
            self.write_filepath.setText(f"{self.file_selected}")
            ...
            for line in lines:
                decoded_text = hushhush.decode_message(line,self.chiper_coder)

                if decoded_text == -1:

                    self.read_attempts += 1
                    msg = f"The passphrase is wrong. You have {3-self.read_attempts} attempt(s) left."
                    self.popup("message",msg)
                    ...
                    decoded_text_to_display += f"{decoded_text}\n"
        ...
        def write_button_Clicked(self):
            ...
            with open(write_filepath,'w') as writer:
